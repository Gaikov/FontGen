...
// nsArgs::Arg:
//---------------------------------------------------------
const char*	nsArgs::Arg( int idx )
{
	if ( idx < 0 || idx >= m_argCount ) return 0;
	return m_args[idx];
}
...
{
	char	*str;
	bool	whole;	//true - не делить на слова
};
...
//---------------------------------------------------------
// nsArgs::AddFromLine: 
// добавляет параметры в массив параметров
// просто делит по словам
//---------------------------------------------------------
